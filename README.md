...
- [Valentine's Love Letters](http://ily-app.s3-website.us-east-2.amazonaws.com/): A just-for-fun weekend project (try one of these names: Lucy, Wing, Oscar, Monica)

## 🧰 languages and skills
- **Programming Languages:** Python, Java, JavaScript, TypeScript, Bash, C, C#
- **AWS Technologies:** API Gateway, Lambda, DynamoDB, S3, CloudWatch, Athema, Iceberg, Glue, GuardDuty, SQS
- **Frameworks:** React, React Native, Angular, Spring, Flask, ExpressJS, NodeJS
- **Databases:** SQL, PL/SQL, MongoDB, DynamoDB
- **Testing:** JUnit, Postman, pytest, MonkeyPatch
- **Soft Skills:** Communication, Leadership, Collaboration, Problem-Solving, Time Management
- **Other:** Git, Linux CLI, NumPy, Pandas, SciKit-Learn, Seaborn, MatPlotLib, TensorFlow
